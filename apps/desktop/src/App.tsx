...
export default function App() {
  ...
  const startWindowDrag = (event: MouseEvent<HTMLElement>) => {
    if (event.buttons !== 1 || !(event.target instanceof Element)) return;
