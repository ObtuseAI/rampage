        ...
        {step === 0 && <>
          ...
          {choice === "owner"
            ...
            : <div className="join-flow">
              ...
              {pairing.state === "searching" && <div className="join-state active"><Radar size={24} /><strong>Looking for your main PC…</strong><span>Rampage will keep looking for 15 minutes. Keep the main PC open—nothing needs to be typed.</span><i className="pairing-pulse" aria-hidden="true" /></div>}
